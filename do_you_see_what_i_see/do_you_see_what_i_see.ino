...
void loop() {
  int residents[10] = { 8, 8, 8, 8, 9, 10, 10, 10, 10, 15 };     //{ 1, 14, 4, 15, 20, 3, 10, 4, 0, 6 }
  ...
  int governments[10] = { 0, 20, 0, 0, 0, 15, 0, 15, 0, 0 };   //{ 5, 15, 10, 12, 3, 9, 9, 8, 4, 2 }
  int academics[10] = { 0, 30, 0, 0, 0, 0, 20, 0, 0, 0 };      //{ 4, 20, 9, 5, 4, 4, 19, 4, 0, 2 }
  int makers[10] = { 15, 0, 0, 0, 0, 0, 35, 0, 0, 0 };         // { 11, 10, 3, 3, 3, 3, 25, 2, 1, 3 }
  int owners[10] = { 10, 18, 10, 10, 9, 8, 8, 8, 8, 8 };       //{ 4, 21, 8, 11, 12, 8, 10, 5, 3, 3 }
